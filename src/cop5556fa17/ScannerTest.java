...
public class ScannerTest {
	...
	*/
	...
	@Test
	public void testopr() throws LexicalException {
	String input = "+";  
	show(input);        
	Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
	show(scanner);   
	...
	@Test
	public void testT() throws LexicalException {
	String input = "*";  
	show(input);        
	Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
	show(scanner);   
	...
	@Test
	public void testop33() throws LexicalException {
	String input = "=";  
	show(input);        
	Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
	show(scanner);   
	...
	@Test
	public void testopp() throws LexicalException {
	String input = "===";  
	show(input);        
	Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
	show(scanner);   
	...
	@Test
	public void testOp44() throws LexicalException {
	String input = "     ===";  
	show(input);        
	Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
	show(scanner);   
	...
	@Test
	public void testOp55() throws LexicalException {
	String input = "absDef=";  
	show(input);        
	Scanner scanner = new Scanner(input).scan();  //Create a Scanner and initialize it
	show(scanner);   
